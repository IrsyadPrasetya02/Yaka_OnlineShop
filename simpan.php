...
if (isset($_POST['simpan'])) {
    ...
    $sql = "INSERT INTO produk (nama_produk, kategori, deskripsi, harga, gender, stok, ukuran, warna, fitur, foto) 
            VALUES ('$nama_produk', '$kategori', '$deskripsi', '$harga', '$gender', '$stok', '$ukuran', '$warna', '$fitur', '$foto')";
